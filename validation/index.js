exports.productValidation=(req,res,next)=>{
    ...
    .isNumeric()
    .withMessage('prie only accepts numeric value')
    req.check('countInStock','Stock value is required').notEmpty()
    .isNumeric()
    .withMessage('Stock value only conatins numeric characters')
    req.check('product_description','Product description is required').notEmpty()
    .isLength({
        min:20
    })
    .withMessage('Description must be more then 20 characters')
